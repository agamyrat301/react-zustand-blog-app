...
const Login = () => {
  ...
  const [email, setEmail] = useState('edmund.ritchie@example.com');
  ...
  const SubmitForm = async () =>{
    ...
    try {
      ...
      // Set the token and user data in Zustand store
        ...
        <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 ">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" action="#">
              ...
              <button
                onClick={SubmitForm}
                className="w-full text-white  bg-blue-600 hover:bg-black 
                transition focus:ring-4 focus:outline-none focus:ring-primary-300 rounded-lg px-5
                 py-2.5 text-center text-lg"
                 disabled={Loading}
              >
