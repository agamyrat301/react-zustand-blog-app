  ...
  return (
    <div>
      <div className="flex items-center flex-shrink-0 p-4 pb-0">
        <div className="flex w-12 items-stop">
          <img
        ...
        <div className="w-full p-2 ">
          <textarea
            className="w-full h-10 text-lg text-gray-900 placeholder:text-gray-400 bg-transparent border-0  focus:ring-0 outline-none"
            placeholder="whats happening?"
          ></textarea>
        </div>
      </div>

      <div className="flex p-2 pl-14">
        <div className="flex w-full text-white">
          <div className="p-2 text-blue-400 rounded-full cursor-pointer">
